...
bool AppInit(int argc, char* argv[])
{
    ...
    extern char ASSETCHAINS_SYMBOL[16]; extern uint64_t ASSETCHAINS_SUPPLY; char *symbol; //uint64_t symbol;
    ...
    strncpy(ASSETCHAINS_SYMBOL,symbol,sizeof(ASSETCHAINS_SYMBOL)-1);
